...
<body>
    ...
    <section id="panel_prawy">
        ...
        <?php
            $polaczenie=mysqli_connect('localhost','root','','poradnia');
            $podane_id=$_POST['id'];
            $zap2 = mysqli_query($polaczenie,"SELECT imie,nazwisko,leki_przepisane,opis FROM pacjenci WHERE id = '$podane_id'");
            while ($wynik2=mysqli_fetch_row($zap2)) {
                echo "Imię i nazwisko: ".$wynik2[0]." ".$wynik2[1]."<br>";
                echo "Przypisane leki: ".$wynik2[2]."<br>";
                echo "Opis choroby: ".$wynik2[3]."<br>";
            }
        ?>
    </section>
    <footer>
