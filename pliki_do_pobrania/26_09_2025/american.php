...
<body>
    ...
    <main>
        ...
        <?php
            ...
            $zap2 = mysqli_query($pol,'SELECT DISTINCT(swinki.data_ur),rasy.rasa,swinki.miot FROM rasy JOIN swinki ON swinki.id = rasy.id WHERE swinki.id = 6;');
        ...
        <?php
            ...
            $zap3 = mysqli_query($pol,'SELECT imie,cena,opis FROM swinki WHERE rasy_id=6;');
